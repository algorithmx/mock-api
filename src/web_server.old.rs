// old implementation using thread pool does not pass stress test
// as the threads are not properly terminated
// memory usage is crazily high

// new implementation using tokio
